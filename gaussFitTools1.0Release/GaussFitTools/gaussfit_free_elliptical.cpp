...
///and distributed http://www.ics.forth.gr/~lourakis/levmar/
 ...
 // Fits to a Continuous Elliptical gaussian model fitting parameters - A, sigma_x, sigma_y, b, Xo, Yo, theta
...
//====================================================================================
 ...
 //========DATA RETRIEVAL FROM MATLAB============
  const int numEqualityConstraints = 0;
  ...
  const int numBounds = 2 * 4; //2 * number of variables you want to define bounds for, to account for upper and lower bounding, in this case sigma, Xo, Yo
                               //A hardcoded as 0 to 65535 (16^4)
                               //b hardcoded as -65535 to 65535 (16^4)
