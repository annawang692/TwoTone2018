...
///and distributed http://www.ics.forth.gr/~lourakis/levmar/
 ...
 // Fits to a Continuous Circular gaussian model fitting parameters - A and b  with width and position fixed by input
...
///SETUP
  ...
  char *variant = "fixedsigmaposition";
...
//====================================================================================
 ...
 //========DATA RETRIEVAL FROM MATLAB============
  const int numEqualityConstraints = 3;
