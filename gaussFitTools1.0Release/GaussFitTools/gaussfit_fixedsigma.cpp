...
///and distributed http://www.ics.forth.gr/~lourakis/levmar/
 ...
 // Fits to a Continuous Circular gaussian model fitting parameters - A, b, Xo, Yo, with width fixed by input
...
//====================================================================================
 ...
 //========DATA RETRIEVAL FROM MATLAB============
  const int numEqualityConstraints = 1;
