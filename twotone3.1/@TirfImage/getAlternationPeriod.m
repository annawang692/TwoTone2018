function AlternationPeriod = getAlternationPeriod(TirfImage)
%  	AlternationPeriod = getAlternationPeriod(TirfImage)
% get AlternationPeriod from TirfImage object
%
...
AlternationPeriod = TirfImage.AlternationPeriod;
